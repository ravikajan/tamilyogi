...
const Card = ({ image, title, year, genre, rating }: CardProps) => (
  <div className="movie-card flex-none w-36 sm:w-48 md:w-56 bg-gray-900 rounded-lg overflow-hidden transition-all">
    ...
    <div className="p-3 sm:p-4">
      <h3 className="font-bold text-sm sm:text-base mb-1 truncate">{title}</h3>
