  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-[#1a1a2e] to-[#16213e] text-white overflow-hidden auth-container">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
        ...
        <div
          className="absolute bottom-40 right-20 w-6 h-6 bg-blue-500 rounded-full floating-animation opacity-40"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-1/2 left-10 w-3 h-3 bg-purple-500 rounded-full floating-animation opacity-50"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 w-2 h-2 bg-yellow-500 rounded-full floating-animation opacity-30"
      ...
      <div className="w-full max-w-md z-10 p-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-red-500 mb-2">TamilYogiVip</h1>
        ...
        <div className="glass-effect rounded-xl p-6 shadow-xl">
          {" "}
          {/* Reduced padding, border radius, and shadow */}
          {/* Tab Switcher */}
          <div className="flex bg-gray-800 rounded-lg p-1 mb-6">
            {" "}
            {/* Reduced margin-bottom */}
            <button
              className={`tab-button flex-1 py-3 px-4 rounded-md text-sm font-medium transition-all ${
                activeTab === "login"
